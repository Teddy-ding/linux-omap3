...
static struct omap_board_mux omap35x_board_mux[] __initdata = {
	...
	/*mcbsp2*/
	OMAP3_MUX(MCBSP2_FSX, OMAP_MUX_MODE2 | OMAP_PIN_INPUT_PULLUP |
				OMAP_PIN_OFF_INPUT_PULLUP ),
	OMAP3_MUX(MCBSP2_CLKX, OMAP_MUX_MODE2 | OMAP_PIN_INPUT_PULLUP |
				OMAP_PIN_OFF_INPUT_PULLUP ),
	OMAP3_MUX(MCBSP2_DR, OMAP_MUX_MODE2 | OMAP_PIN_INPUT_PULLUP |
				OMAP_PIN_OFF_INPUT_PULLUP ),

	OMAP3_MUX(MCBSP2_DX, OMAP_MUX_MODE2 | OMAP_PIN_OUTPUT),
